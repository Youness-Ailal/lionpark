...
/* empty css                             *//* empty css                             */import { $ as $$FAQ } from './Contact_6958ab00.mjs';
...
const $$TicketsHero = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="tickets"><div class="container tickets__container"><div class="tickets__top"><h2 class="heading-second tickets__title page-title">
Purchase Your tickets
</h2><!-- <div class="tickets__options">
...
const $$Tickets = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Tickets;
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Tickets", "description": "Purchase your tickets online for a memorable lion encounter at our park in Agadir, Morocco. Book your visit now for a wildly exciting day with our pride!" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "TicketsHero", $$TicketsHero, {})}${renderComponent($$result2, "FAQ", $$FAQ, {})}${renderComponent($$result2, "Location", $$Location, {})}` })}`;
