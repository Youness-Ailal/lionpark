...
import 'clsx';
import { $ as $$Icon, l as lion1, d as lion7, e as lion3, f as lion4, a as $$MainLayout } from './Animals_cd45b04a.mjs';
/* empty css                           */import { $ as $$FAQ } from './Gallery_698737c2.mjs';
import { $ as $$Location } from './Tickets_4644f517.mjs';
import 'html-escaper';
...
const $$Hero = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Hero;
  return renderTemplate`${maybeRenderHead()}<section class="hero"><div class="hero__top"><div class="hero__buttons"><a href="#location" class="hero__select select-btn">${renderComponent($$result, "Icon", $$Icon, { "class": "icon", "name": "carbon:location" })}Get Location</a><a href="#map-cart" class="hero__select select-btn">${renderComponent($$result, "Icon", $$Icon, { "class": "icon", "name": "iconoir:map" })}Zoo Map</a><a href="#faq" class="hero__select select-btn">${renderComponent($$result, "Icon", $$Icon, { "class": "icon", "name": "ic:outline-contact-support" })}Get Advice</a></div></div><div class="hero__content"><div class="hero__mid"><h1 class="hero__title heading">
