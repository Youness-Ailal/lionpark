...
const $$Astro$i = createAstro("https://lionpark.netlify.app");
...
const $$Astro$h = createAstro("https://lionpark.netlify.app");
...
const $$Astro$g = createAstro("https://lionpark.netlify.app");
...
const $$Astro$f = createAstro("https://lionpark.netlify.app");
...
const $$Astro$e = createAstro("https://lionpark.netlify.app");
const $$DropNav = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$e, $$props, $$slots);
  Astro2.self = $$DropNav;
  return renderTemplate`${maybeRenderHead()}<div class="dropdown hidden-drop"><ul><li class="dropdown__item"><a href="/">${renderComponent($$result, "Icon", $$Icon, { "class": "icon dropdown__icon", "name": "carbon:home" })}Home</a></li><li class="dropdown__item"><a href="/Animals">${renderComponent($$result, "Icon", $$Icon, { "class": "icon dropdown__icon", "name": "mdi:pets" })}Animals</a></li><li class="dropdown__item"><a href="/Tickets">${renderComponent($$result, "Icon", $$Icon, { "class": "icon dropdown__icon", "name": "carbon:ticket" })}Tickets</a></li><li class="dropdown__item"><a href="/Gallery">${renderComponent($$result, "Icon", $$Icon, { "class": "icon dropdown__icon", "name": "clarity:image-gallery-line" })}Photo Gallery</a></li><li class="dropdown__item"><a href="/Contact">${renderComponent($$result, "Icon", $$Icon, { "class": "icon dropdown__icon", "name": "ic:outline-contact-support" })}Contact</a></li><!-- <li class="dropdown__item">
      <Icon class="icon dropdown__icon" name="octicon:info-16" />
      <a href="/Gallery">About us</a>
    </li> --></ul><div class="dropdown__bottom"><div class="header__right dropdown__bottom--elements"><div class="header__open dropdown__bottom-links"><div class="header__open--dot"></div><p class="header__open--p">open daily 9:00 to 17:00 (GMT+1)</p></div><a href="tel:+212624360624" class="header__phone link dropdown__bottom-links">${renderComponent($$result, "Icon", $$Icon, { "class": "header__phone--icon icon", "name": "ph:phone-light" })}
...
const $$Astro$d = createAstro("https://lionpark.netlify.app");
...
const $$Astro$b = createAstro("https://lionpark.netlify.app");
...
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/components/OpenGraphArticleTags.astro", void 0);

const $$Astro$a = createAstro("https://lionpark.netlify.app");
const $$OpenGraphBasicTags = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$a, $$props, $$slots);
  Astro2.self = $$OpenGraphBasicTags;
  const { openGraph } = Astro2.props;
  return renderTemplate`<meta property="og:title"${addAttribute(openGraph.basic.title, "content")}><meta property="og:type"${addAttribute(openGraph.basic.type, "content")}><meta property="og:image"${addAttribute(openGraph.basic.image, "content")}><meta property="og:url"${addAttribute(openGraph.basic.url || Astro2.url.href, "content")}>`;
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/components/OpenGraphBasicTags.astro", void 0);

const $$Astro$9 = createAstro("https://lionpark.netlify.app");
...
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/components/OpenGraphImageTags.astro", void 0);

const $$Astro$8 = createAstro("https://lionpark.netlify.app");
...
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/components/OpenGraphOptionalTags.astro", void 0);
...
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/components/ExtendedTags.astro", void 0);
...
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/components/TwitterTags.astro", void 0);
...
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/components/LanguageAlternatesTags.astro", void 0);
...
}, "C:/Users/Youness/Desktop/Crocopark/node_modules/astro-seo/src/SEO.astro", void 0);

const $$Astro$3 = createAstro("https://lionpark.netlify.app");
const $$MainLayout = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$MainLayout;
  const desc = "Observe majestic African lions up close at the only lion park in Agadir, Morocco. A unique and thrilling family wildlife experience.";
  const { title, description = desc } = Astro2.props;
  const completeTitle = `${title} | Lion Park Agadir `;
  return renderTemplate`<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">${renderComponent($$result, "SEO", $$SEO, { "canonical": "https://lionpark.netlify.app", "openGraph": {
    article: {
      authors: ["Youness Ailal"],
      publishedTime: "01 November 2023"
    },
    basic: {
      title: "Lion Park Agadir - Get Close to Wild Lions",
      type: "website",
      url: "https://lionparkagadir.com",
      image: "https://images.unsplash.com/photo-1456926631375-92c8ce872def?auto=format&fit=crop&q=80&w=1740&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    }
  }, "twitter": {
    card: "summary_large_image",
    imageAlt: "Lynxes are medium-sized felids",
    site: "https://lionpark.netlify.app",
    creator: "@younessailal",
    image: "https://images.unsplash.com/photo-1456926631375-92c8ce872def?auto=format&fit=crop&q=80&w=1740&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  } })}<link rel="shortcut icon" href="/favicon.svg" type="image/x-icon"><title>${`${completeTitle} | Lion Park Agadir`}</title><meta name="description"${addAttribute(description, "content")}>${renderHead()}</head><body>${renderComponent($$result, "Navigation", $$Navigation, {})}<main>${renderSlot($$result, $$slots["default"])}</main>${renderComponent($$result, "Footer", $$Footer, {})}</body></html>`;
...
const $$AnimalsHero = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="animals"><div class="container animals__container"><h2 class="heading-second animals__title page-title">Meet Our Big Cats</h2><ul class="animals__list">${animals.map((animal) => {
...
const $$Animals = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Animals;
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Zoo Animals", "description": "See magnificent lions, tigers, leopards, and more big cats up close at our one-of-a-kind zoo in Agadir, Morocco. Learn about these incredible predators while enjoying a thrilling family day out." }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "AnimalsHero", $$AnimalsHero, {})}` })}`;
